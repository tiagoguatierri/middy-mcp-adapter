...
- Limited `@modelcontextprotocol/sdk` peer dependency to `<1.25.0` due to breaking changes in v1.25.0
- Updated to use `@modelcontextprotocol/sdk@1.24.3` as the recommended version
